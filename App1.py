...
if IS_DARK:
    ...
    --table-even:    #212D40;
    /* Dans CSS_VARS */
    --table-header-bg:  {BLEU};      /* Fond en-tête */
    --table-header-text: {BLEU};       /* Texte en-tête */
    --table-cell-text: var(--text-primary);  /* Texte cellules */
    --table-code-text: #1E6FD9;       /* Texte des balises code */
    """
...
if PAGE == "🏠  Accueil":
    st.markdown(f"""<div style='margin-bottom:20px;'>
      <h1 style='font-size:2.1rem;font-weight:700;color:var(--text-primary);margin:0;'>Prédiction du Trafic Urbain</h1>
      <p style='color:var(--text-secondary);font-size:1rem;margin-top:6px;'>
    ...
    with cR:
        ...
        for c,n,t,d in [
            ...
            <div style='display:flex;gap:12px;margin-bottom:10px;align-items:flex-start;'>
              ...
              <div>
                <div style='font-weight:600;font-size:.87rem;color:var(--text-primary);'>{t}</div>
                <div style='font-size:.76rem;color:var(--text-secondary);'>{d}</div>
              </div></div>""", unsafe_allow_html=True)
